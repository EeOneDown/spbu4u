...
ask_to_input_educator = "Введи Фамилию преподавателя: (и И. О. по желанию)"
...
ask_to_select_day_answer = "Выбери день, в котором есть занятие с большим " \
                           "количеством преподавателей:"
no_edu_days_answer = "Нет занятий с большим количеством преподавателей"
ask_to_feedback = "Напиши мне что-нибудь:"
rate_answers = [
        "Оцените качество сервиса:",
        ("{0} Единица? Быть может, я могу что-то исправить? Сделать лучше?\n\n"
         "Опиши проблему <a href='https://t.me/eeonedown'>разработчику</a>, и "
         "вместе мы ее решим!".format(emoji["disappointed"])),
        ("{0} Двойка? Быть может, я могу что-то исправить? Сделать лучше?\n\n"
         "Опиши проблему <a href='https://t.me/eeonedown'>разработчику</a>, и "
         "вместе мы ее решим!".format(emoji["disappointed"])),
        ("{0} Удовлетворительно? Ничего... тоже оценка. Буду стараться "
         "лучше.".format(emoji["cold_sweat"])),
        "{0} Стабильная четверочка. Спасибо!".format(emoji["halo"]),
        "{0} Пятёрка! Супер! Спасибо большое!".format(emoji["smile"])
    ]
alt_reg_text = "Альтернативный способ"
alt_reg_answer = (
    "<b>Альтернативный способ входа</b>\n\n"
    "1. Открой на <a href='https://timetable.spbu.ru'>сайте расписания</a> "
    "расписание нужной группы или преподавателя;\n"
    "2. Отправь боту ссылку любого вида "
...
schedule_changed_answer = "{0} В расписании появились изменения!\nЗаходи и проверь текущую неделю.".format(
    emoji["warning"]
)
current_week_text = "Текущая неделя"
